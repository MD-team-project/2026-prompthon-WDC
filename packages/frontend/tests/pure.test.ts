...
// ---------------------------------------------------------------------------
// Today's context: held in state for the character's own reasoning even
// though FE no longer renders it (the HUD scenario row replaced the reading
// display, not the fetch/reducer state behind it).
// ---------------------------------------------------------------------------
